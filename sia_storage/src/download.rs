...
impl Download {
    ...
    fn spawn_next(&mut self) -> bool {
        ...
        // then covers a real share of what is in flight, and
        // `successes * limit / Σ elapsed` is chunks in flight over chunk
        // latency — the rate at which the download actually progresses.
