...
def _uniffi_check_api_checksums(lib):
    if lib.uniffi_indexd_ffi_checksum_func_set_log_callback() != 42505:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indexd_ffi_checksum_method_app_connect() != 11053:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indexd_ffi_checksum_method_app_download() != 52737:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indexd_ffi_checksum_method_app_upload() != 40202:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indexd_ffi_checksum_method_chunkedbuffer_close() != 37810:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indexd_ffi_checksum_method_chunkedbuffer_push_chunk() != 22337:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indexd_ffi_checksum_method_chunkedbuffer_read_chunk() != 34409:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indexd_ffi_checksum_method_download_read() != 48238:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indexd_ffi_checksum_method_logger_debug() != 63698:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indexd_ffi_checksum_method_logger_info() != 45154:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indexd_ffi_checksum_method_logger_warn() != 30434:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indexd_ffi_checksum_method_logger_error() != 13402:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indexd_ffi_checksum_method_upload_finish() != 3277:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indexd_ffi_checksum_method_upload_write() != 18591:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indexd_ffi_checksum_constructor_app_new() != 32713:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_indexd_ffi_checksum_constructor_chunkedbuffer_new() != 41954:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
...
_UniffiLib.uniffi_indexd_ffi_fn_clone_app.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_indexd_ffi_fn_clone_app.restype = ctypes.c_void_p
_UniffiLib.uniffi_indexd_ffi_fn_free_app.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_indexd_ffi_fn_free_app.restype = None
_UniffiLib.uniffi_indexd_ffi_fn_constructor_app_new.argtypes = (
    _UniffiRustBuffer,
    _UniffiRustBuffer,
    _UniffiRustBuffer,
    _UniffiRustBuffer,
...
_UniffiLib.uniffi_indexd_ffi_fn_constructor_app_new.restype = ctypes.c_void_p
_UniffiLib.uniffi_indexd_ffi_fn_method_app_connect.argtypes = (
    ctypes.c_void_p,
)
_UniffiLib.uniffi_indexd_ffi_fn_method_app_connect.restype = ctypes.c_uint64
_UniffiLib.uniffi_indexd_ffi_fn_method_app_download.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
)
_UniffiLib.uniffi_indexd_ffi_fn_method_app_download.restype = ctypes.c_uint64
_UniffiLib.uniffi_indexd_ffi_fn_method_app_upload.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
    ctypes.c_uint8,
    ctypes.c_uint8,
)
_UniffiLib.uniffi_indexd_ffi_fn_method_app_upload.restype = ctypes.c_uint64
_UniffiLib.uniffi_indexd_ffi_fn_clone_chunkedbuffer.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_indexd_ffi_fn_clone_chunkedbuffer.restype = ctypes.c_void_p
_UniffiLib.uniffi_indexd_ffi_fn_free_chunkedbuffer.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_indexd_ffi_fn_free_chunkedbuffer.restype = None
_UniffiLib.uniffi_indexd_ffi_fn_constructor_chunkedbuffer_new.argtypes = (
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_indexd_ffi_fn_constructor_chunkedbuffer_new.restype = ctypes.c_void_p
_UniffiLib.uniffi_indexd_ffi_fn_method_chunkedbuffer_close.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_indexd_ffi_fn_method_chunkedbuffer_close.restype = None
_UniffiLib.uniffi_indexd_ffi_fn_method_chunkedbuffer_push_chunk.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
)
_UniffiLib.uniffi_indexd_ffi_fn_method_chunkedbuffer_push_chunk.restype = ctypes.c_uint64
_UniffiLib.uniffi_indexd_ffi_fn_method_chunkedbuffer_read_chunk.argtypes = (
    ctypes.c_void_p,
)
_UniffiLib.uniffi_indexd_ffi_fn_method_chunkedbuffer_read_chunk.restype = ctypes.c_uint64
...
_UniffiLib.uniffi_indexd_ffi_fn_method_download_read.argtypes = (
    ctypes.c_void_p,
)
_UniffiLib.uniffi_indexd_ffi_fn_method_download_read.restype = ctypes.c_uint64
...
_UniffiLib.uniffi_indexd_ffi_fn_method_upload_finish.argtypes = (
    ctypes.c_void_p,
)
_UniffiLib.uniffi_indexd_ffi_fn_method_upload_finish.restype = ctypes.c_uint64
...
_UniffiLib.uniffi_indexd_ffi_fn_func_set_log_callback.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_indexd_ffi_fn_func_set_log_callback.restype = None
...
_UniffiLib.uniffi_indexd_ffi_checksum_func_set_log_callback.argtypes = (
)
_UniffiLib.uniffi_indexd_ffi_checksum_func_set_log_callback.restype = ctypes.c_uint16
_UniffiLib.uniffi_indexd_ffi_checksum_method_app_connect.argtypes = (
)
_UniffiLib.uniffi_indexd_ffi_checksum_method_app_connect.restype = ctypes.c_uint16
_UniffiLib.uniffi_indexd_ffi_checksum_method_app_download.argtypes = (
)
_UniffiLib.uniffi_indexd_ffi_checksum_method_app_download.restype = ctypes.c_uint16
_UniffiLib.uniffi_indexd_ffi_checksum_method_app_upload.argtypes = (
)
_UniffiLib.uniffi_indexd_ffi_checksum_method_app_upload.restype = ctypes.c_uint16
_UniffiLib.uniffi_indexd_ffi_checksum_method_chunkedbuffer_close.argtypes = (
)
_UniffiLib.uniffi_indexd_ffi_checksum_method_chunkedbuffer_close.restype = ctypes.c_uint16
_UniffiLib.uniffi_indexd_ffi_checksum_method_chunkedbuffer_push_chunk.argtypes = (
)
_UniffiLib.uniffi_indexd_ffi_checksum_method_chunkedbuffer_push_chunk.restype = ctypes.c_uint16
_UniffiLib.uniffi_indexd_ffi_checksum_method_chunkedbuffer_read_chunk.argtypes = (
)
_UniffiLib.uniffi_indexd_ffi_checksum_method_chunkedbuffer_read_chunk.restype = ctypes.c_uint16
_UniffiLib.uniffi_indexd_ffi_checksum_method_download_read.argtypes = (
)
_UniffiLib.uniffi_indexd_ffi_checksum_method_download_read.restype = ctypes.c_uint16
...
_UniffiLib.uniffi_indexd_ffi_checksum_method_upload_finish.argtypes = (
)
_UniffiLib.uniffi_indexd_ffi_checksum_method_upload_finish.restype = ctypes.c_uint16
...
_UniffiLib.uniffi_indexd_ffi_checksum_constructor_app_new.argtypes = (
)
_UniffiLib.uniffi_indexd_ffi_checksum_constructor_app_new.restype = ctypes.c_uint16
_UniffiLib.uniffi_indexd_ffi_checksum_constructor_chunkedbuffer_new.argtypes = (
)
_UniffiLib.uniffi_indexd_ffi_checksum_constructor_chunkedbuffer_new.restype = ctypes.c_uint16
...
class Slab:
    ...
    offset: "int"
    length: "int"
    def __init__(self, *, id: "str", encryption_key: "bytes", min_shards: "int", offset: "int", length: "int"):
        self.id = id
    ...
    def __str__(self):
        return "Slab(id={}, encryption_key={}, min_shards={}, offset={}, length={})".format(self.id, self.encryption_key, self.min_shards, self.offset, self.length)
...
class AppProtocol(typing.Protocol):
    def connect(self, ):
        raise NotImplementedError
    def download(self, slabs: "typing.List[Slab]"):
        raise NotImplementedError
...
class App():
    ...
    def __init__(self, url: "str",name: "str",app_seed: "bytes",description: "str"):
        ...
        self._pointer = _uniffi_rust_call_with_error(_UniffiConverterTypeError,_UniffiLib.uniffi_indexd_ffi_fn_constructor_app_new,
    ...
    def __del__(self):
        ...
        pointer = getattr(self, "_pointer", None)
        if pointer is not None:
            _uniffi_rust_call(_UniffiLib.uniffi_indexd_ffi_fn_free_app, pointer)

    def _uniffi_clone_pointer(self):
        return _uniffi_rust_call(_UniffiLib.uniffi_indexd_ffi_fn_clone_app, self._pointer)
    ...
    async def connect(self, ) -> None:
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_indexd_ffi_fn_method_app_connect(
...
_UniffiConverterTypeError,
    ...
    async def download(self, slabs: "typing.List[Slab]") -> "Download":
        _UniffiConverterSequenceTypeSlab.check_lower(slabs)
        
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_indexd_ffi_fn_method_app_download(
                self._uniffi_clone_pointer(), 
        _UniffiConverterSequenceTypeSlab.lower(slabs)
            ),
...
_UniffiConverterTypeError,
    ...
    async def upload(self, encryption_key: "bytes",data_shards: "int",parity_shards: "int") -> "Upload":
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_indexd_ffi_fn_method_app_upload(
                self._uniffi_clone_pointer(), 
...
class ChunkedBuffer():
    _pointer: ctypes.c_void_p
    def __init__(self, ):
        self._pointer = _uniffi_rust_call(_UniffiLib.uniffi_indexd_ffi_fn_constructor_chunkedbuffer_new,)

    def __del__(self):
        # In case of partial initialization of instances.
        pointer = getattr(self, "_pointer", None)
        if pointer is not None:
            _uniffi_rust_call(_UniffiLib.uniffi_indexd_ffi_fn_free_chunkedbuffer, pointer)

    def _uniffi_clone_pointer(self):
        return _uniffi_rust_call(_UniffiLib.uniffi_indexd_ffi_fn_clone_chunkedbuffer, self._pointer)
    ...
    def close(self, ) -> None:
        _uniffi_rust_call_with_error(_UniffiConverterTypeError,_UniffiLib.uniffi_indexd_ffi_fn_method_chunkedbuffer_close,self._uniffi_clone_pointer(),)
    ...
    async def push_chunk(self, chunk: "bytes") -> None:
        ...
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_indexd_ffi_fn_method_chunkedbuffer_push_chunk(
                self._uniffi_clone_pointer(), 
...
_UniffiConverterTypeError,
    ...
    async def read_chunk(self, ) -> "bytes":
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_indexd_ffi_fn_method_chunkedbuffer_read_chunk(
                self._uniffi_clone_pointer(), 
            ),
...
class Download():
    ...
    async def read(self, ) -> "bytes":
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_indexd_ffi_fn_method_download_read(
                self._uniffi_clone_pointer(), 
            ),
            _UniffiLib.ffi_indexd_ffi_rust_future_poll_rust_buffer,
            _UniffiLib.ffi_indexd_ffi_rust_future_complete_rust_buffer,
...
class Upload():
    ...
    async def finish(self, ) -> "typing.List[Slab]":
        return await _uniffi_rust_call_async(
            _UniffiLib.uniffi_indexd_ffi_fn_method_upload_finish(
                self._uniffi_clone_pointer(), 
            ),
            _UniffiLib.ffi_indexd_ffi_rust_future_poll_rust_buffer,
            _UniffiLib.ffi_indexd_ffi_rust_future_complete_rust_buffer,
            _UniffiLib.ffi_indexd_ffi_rust_future_free_rust_buffer,
            # lift function
            _UniffiConverterSequenceTypeSlab.lift,
...
def set_log_callback(callback: "Logger") -> None:
    ...
    _uniffi_rust_call(_UniffiLib.uniffi_indexd_ffi_fn_func_set_log_callback,
