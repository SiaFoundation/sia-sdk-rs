...
pub use merkle::{ProofValidationError, RangeProof, sector_root};
...
/// A trait for signing file contract revisions as a renter. This is used to abstract over different ways
/// of managing the renter's keys.
...
/// A trait for building transactions that are used in RHP interactions, such as
/// forming a contract.
