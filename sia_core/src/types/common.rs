...
#[derive(Debug, PartialEq, SiaEncode, SiaDecode, AsyncSiaDecode, Serialize, Deserialize)]
...
#[derive(
    Default, Debug, PartialEq, Clone, SiaEncode, V1SiaEncode, SiaDecode, V1SiaDecode, AsyncSiaDecode,
)]
...
#[derive(
    Debug, PartialEq, Clone, SiaEncode, V1SiaEncode, SiaDecode, V1SiaDecode, AsyncSiaDecode,
)]
...
mod tests {
    ...
    cross_target_tests! {
    async fn test_serialize_hash256() {
    ...
    async fn test_serialize_address() {
    ...
    async fn test_transaction_derive() {
    ...
    async fn test_transaction_id_v2_derive() {
    ...
    async fn test_siafund_output_id_derive() {
